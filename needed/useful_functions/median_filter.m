function out=median_filter(im,type,r)
%function out=median_filter(im,type,r)
%
%Applique le filtre median  a l'image im par un masque de
%rayon r.
...
% 
% Applies a median filter on the image im with a mask of radius r
