function out=dilation_filter(im,type,r)
%function out=dilation_filter(im,type,r)
%
%Effectue la dilatation morphologique de l'image im par un masque de
%rayon r.
...
% 
% Performs a dilation on the image im with a mask of radius r
