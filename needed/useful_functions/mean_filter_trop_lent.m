function out=mean_filter(im,type,r)
%function out=mean_filter(im,type,r)
%
%Effectue le filtre de la moyenne  sur l'image im par un masque de
%rayon r.
% si type == 1, le masque est un carre (de cote 2*r+1)
...
% 
% Performs the mean filter on the image im with a mask of radius r
% if type ==1, the mask is a square, the side of which is 2*r+1
...
tmpcoeffs=tmpvals;
orig_vals=((im(ydeb:yfin,xdeb:xfin))(:))';
